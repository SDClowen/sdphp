...
class Upload 
{
    ...
    function upload($file) {
        ...
        $this->translation = require_once(LANG_DIR."/upload/".$this->lang.".php");
     ...
     *
     * @access private
     * @param  string    $offsets  Offsets, as an integer, a string or an array
     ...
     */
    function getoffsets(string $offsets, $x, $y, $round = true, $negative = true) {
